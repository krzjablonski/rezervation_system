...
@section('content')
  <div class="row">
    <div class="col-md-121">
      ...
      <p class='small'>Możesz zmienić nazwę albumu i zdjęcia, które są do niego przypisane</p>
    </div>
  </div>

  <div class="row mt-3">
    <div class="col-md-12">
      {{ Form::model($album, ['route' => ['albums.update', $album->id]]) }}
